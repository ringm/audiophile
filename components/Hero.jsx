...
export default function Hero() {
  return (
    <div className="flex justify-center items-center bg-darkSec">
      <div className="flex w-11/12 max-w-screen-lg h-520px bg-home-mobile md:bg-home-tablet lg:bg-home-desktop bg-no-repeat bg-cover bg-center">
